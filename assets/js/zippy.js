...
;(function(factory){
     ...
     */
      ...
      Zippy.prototype.activate = function(){
          ...
          this.$el.find('.indicators li').eq(0).addClass('active zoomInUp animated');
      };
     ...
     */
      ...
      Zippy.prototype.changeSlide = function(e){
          ...
          var $nextSlide = this.$el.find('.slide').eq(this.currSlide).addClass(direction + ' active zoomInUp animated');
      ...
      //Init CSS transitions
          ...
          setTimeout(function(){
              ...
              this.$currSlide.removeClass('active zoomInUp animated shift-left shift-right');
              this.$currSlide = $nextSlide.removeClass(direction+' zoomInUp animated');
      ...
      Zippy.prototype._jsAnimation = function($nextSlide,direction){
       ...
       var animation = {};
          ...
          $nextSlide.animate(animation,this.settings.speed,'swing',function(){
              ...
              _.$currSlide.removeClass('active js-reset-left zoomInUp animated').attr('style','');
              //Cache the next slide after classes and inline styles have been removed
              _.$currSlide = $nextSlide.removeClass(direction+' zoomInUp animated' ).attr('style','');
              _._updateIndicators();
              _.startTimer();
          });
      };
    ...
    /**
      ...
      Zippy.prototype._updateIndicators = function(){
          this.$el.find('.indicators li').removeClass('active zoomInUp animated').eq(this.currSlide).addClass('active zoomInUp animated');
      };
