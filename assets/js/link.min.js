   ...
   a.FroalaEditor.PLUGINS.link = function(b) {
    ...
    function i() {
      ...
      var c = {
        ...
        e = b.popups.create("link.edit", c);
      return b.$wp && b.$wp.on("scroll.link-edit", function() {
        d() && b.popups.isVisible("link.edit") && g(d())
    ...
    function j() {
      !d() && b.$el.find(".fr-marker").length && (b.events.focus(), b.selection.restore())
    }
    ...
    function k() {
      ...
      if (e) {
        var f, g, h = a(e),
          i = c.find('input.fr-link-attr[type="text"]'),
          j = c.find('input.fr-link-attr[type="checkbox"]');
        ...
        c.find('input.fr-link-attr[type="text"][name="text"]').val(h.text())
      } else c.find('input.fr-link-attr[type="text"]').val(""), c.find('input.fr-link-attr[type="checkbox"]').prop("checked", !1), c.find('input.fr-link-attr[type="text"][name="text"]').val(b.selection.text());
      c.find("input.fr-link-attr").trigger("change");
      var k = b.image ? b.image.get() : null;
      k ? c.find('.fr-link-attr[name="text"]').parent().hide() : c.find('.fr-link-attr[name="text"]').parent().show()
    }

    function l() {
      var c = b.$tb.find('.fr-command[data-cmd="insertLink"]'),
        d = b.popups.get("link.insert");
      if (d || (d = m()), !d.hasClass("fr-active"))
        if (b.popups.refresh("link.insert"), b.popups.setContainer("link.insert", b.$tb || a(b.opts.scrollableContainer)), b.selection.save(), c.is(":visible")) {
    ...
    function m() {
      ...
      var i = {
        ...
        l = b.popups.create("link.insert", i);
      return b.popups.onRefresh("link.insert", k), b.popups.onHide("link.insert", j), b.$wp && b.$wp.on("scroll.link-insert", function() {
        var a = b.image ? b.image.get() : null;
        a && b.popups.isVisible("link.insert") && v(), d && b.popups.isVisible("link.insert") && t()
      }), b.events.on("destroy", function() {
    ...
    function n() {
      ...
      return b.events.trigger("link.beforeRemove", [c]) === !1 ? !1 : void(e && c ? (e.unwrap(), e.trigger("click")) : c && (b.selection.save(), a(c).replaceWith(a(c).html()), b.selection.restore(), h()))
    }

    function o() {
      b.events.on("mouseup", f), b.events.on("touchend", f), b.events.on("keyup", function(b) {
        b.which != a.FroalaEditor.KEYCODE.ESC && f(b)
      }), b.events.on("window.mouseup", f)
    }
    ...
    function q() {
      ...
      s(h, i, j), a(b.original_window).scrollTop(k)
    }
    ...
    function s(c, g, h) {
      ...
      i || "A" == b.$el.get(0).tagName ? "A" == b.$el.get(0).tagName && b.$el.focus() : (b.events.focus(!0), b.selection.restore());
      var j = c;
      if (b.opts.linkConvertEmailAddress) {
        var k = /^[\w._]+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/i;
        k.test(c) && 0 !== c.indexOf("mailto:") && (c = "mailto:" + c)
      }
      if (0 === c.indexOf("mailto:") || 0 === c.indexOf("data:image") || "" === b.opts.linkAutoPrefix || /^(https?:|ftps?:|)\/\//.test(c) || (c = b.opts.linkAutoPrefix + c), c = b.helpers.sanitizeURL(c), b.opts.linkAlwaysBlank && (h.target = "_blank"), b.opts.linkAlwaysNoFollow && (h.rel = "nofollow"), g = g || "", c === b.opts.linkAutoPrefix) {
      ...
      if (n) {
        ...
        m.attr("href", c), g.length > 0 && m.text() != g && !i && m.text(g), i || m.prepend(a.FroalaEditor.START_MARKER).append(a.FroalaEditor.END_MARKER), m.attr(h), i || b.selection.restore()
      } else {
        i ? i.wrap('<a href="' + c + '"></a>') : (b.doc.execCommand("unlink", !1, !1), b.selection.isCollapsed() ? (g = 0 === g.length ? j : g, b.html.insert('<a href="' + c + '">' + a.FroalaEditor.START_MARKER + g + a.FroalaEditor.END_MARKER + "</a>"), b.selection.restore()) : g.length > 0 && g != b.selection.text() ? (b.selection.remove(), b.html.insert('<a href="' + c + '">' + a.FroalaEditor.START_MARKER + g + a.FroalaEditor.END_MARKER + "</a>"), b.selection.restore()) : (r(), b.doc.execCommand("createLink", !1, c)));
        for (var q = e(), s = 0; s < q.length; s++) m = a(q[s]), m.attr(h), m.removeAttr("_moz_dirty");
        1 == q.length && b.$wp ? (a(q[0]).prepend(a.FroalaEditor.START_MARKER).append(a.FroalaEditor.END_MARKER), b.selection.restore()) : b.popups.hide("link.insert")
      }
      i ? i.trigger("click") : (b.popups.get("link.insert"), f())
    }
    ...
    function t() {
      ...
      if (c) {
        ...
        e || (e = m()), b.popups.isVisible("link.insert") || (b.popups.refresh("link.insert"), b.selection.save(), b.helpers.isMobile() && (b.events.disableBlur(), b.$el.blur(), b.events.enableBlur())), b.popups.setContainer("link.insert", a(b.opts.scrollableContainer));
        var f = (b.image ? b.image.get() : null) || a(c),
          g = f.offset().left + f.outerWidth() / 2,
          i = f.offset().top + f.outerHeight();
        b.popups.show("link.insert", g, i, f.outerHeight())
      }
    }
    ...
    function u() {
      ...
      if (a) a.trigger("click");
        ...
        var c = d();
        c ? (b.selection.restore(), h(), f()) : (b.popups.hide("link.insert"), b.toolbar.showInline())
      }
    }
    ...
    function v() {
      ...
      if (c) {
        ...
        d || (d = m()), k(!0), b.popups.setContainer("link.insert", a(b.opts.scrollableContainer));
        var e = c.offset().left + c.outerWidth() / 2,
    ...
    function w(c) {
      ...
      if (!b.opts.linkMultipleStyles) {
        ...
        f.splice(f.indexOf(c), 1), a(e).removeClass(f.join(" "))
      }
      a(e).toggleClass(c)
    }
    return {
    ...
    popup: !0,
    callback: function() {
      this.popups.isVisible("link..insert") ? this.popups.hide("link..insert") : this.link.showInsertPopup()
    }
    ...
    refresh: function(b) {
      var c = this.link.get();
      c ? (b.removeClass("fr-hidden"), b.attr("href", a(c).attr("href")).attr("target", "_blank").attr("rel", "nofollow")) : b.addClass("fr-hidden")
    }
    ...
    html: function() {
      ...
      for (var c in b) a += '<li><a class="fr-command" data-cmd="linkStyle" data-param1="' + c + '">' + b[c] + "</a></li>";
      return a += "</ul>"
    },
    callback: function(a, b) {
