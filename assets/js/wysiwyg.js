...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.5.2", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        function i() {
            b.keys.forceUndo(), s = b.snapshot.get(), null === p && (p = r.get(0).innerHTML, b.selection.restore(), b.events.enableBlur());
            var a = p.match(/(class=\"?Mso|class=\'?Mso|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi),
                c = b.events.chainTrigger("paste.beforeCleanup", p);
            c && "string" == typeof c && (p = c), (!a || a && b.events.trigger("paste.wordPaste", [p]) !== !1) && j(p, a)
        }

        function j(c, d, e) {
            var f, i = null,
                j = null;
            if (c.toLowerCase().indexOf("<body") >= 0 && (c = c.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1"), c = c.replace(/([^>])\n([^<])/g, "$1 $2")), !d) {
                var l = b.opts.htmlAllowedStyleProps;
                b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps, b.opts.htmlAllowComments = !1, c = b.clean.html(c, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs), b.opts.htmlAllowedStyleProps = l, b.opts.htmlAllowComments = !0, c = m(c), c = c.replace(/\r|\n|\t/g, "");
                var n = b.doc.createElement("div");
                n.innerHTML = c;
                var o = b.win.localStorage.getItem("fr-copied-html"),
                    p = b.win.localStorage.getItem("fr-copied-text");
                p && n.textContent.replace(/(\u00A0)/gi, " ").replace(/\r|\n/gi, "") == p.replace(/(\u00A0)/gi, " ").replace(/(\r|\n)+([ ]+[\r\n]+)*/gi, " ") && (c = o), c = c.replace(/^ */g, "").replace(/ *$/g, "")
            }
            var q = !1;
            c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^.* id="docs-internal-guid[^>]*>(.*)<\/b>.*$/, "$1"), q = !0), !d || b.wordPaste && e || (c = c.replace(/^\n*/g, "").replace(/^ /g, ""), 0 === c.indexOf("<colgroup>") && (c = "<table>" + c + "</table>"), c = g(c), c = m(c)), b.opts.pastePlain && (c = h(c));
            ...
            if ("string" == typeof r && (c = r), "" !== c) {
                ...
                var w = t.children;
                if (1 == w.length && ["OL", "UL"].indexOf(w[0].tagName) >= 0 && (w[0].outerHTML = w[0].innerHTML), !q) {
                    var x = t.getElementsByTagName("br");
                ...
                if (b.opts.enter == a.FE.ENTER_BR)
                    for (i = t.querySelectorAll("p, div"), f = i.length - 1; f >= 0; f--) j = i[f], j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : "");
                else if (b.opts.enter == a.FE.ENTER_DIV)
                    for (i = t.getElementsByTagName("p"), f = i.length - 1; f >= 0; f--) j = i[f], j.outerHTML = "<div>" + j.innerHTML + "</div>";
                c = t.innerHTML, b.html.insert(c, !0)
            }
            k(), b.undo.saveStep(s), b.undo.saveStep()
        }
        ...
        function d(a, d, e, h) {
            ...
            b.opts.toolbarInline && l && b.$tb && l.get(0) == b.$tb.get(0) && (c(a, b.$sc), e = b.$tb.offset().top - b.helpers.getPX(b.$tb.css("margin-top")), d = b.$tb.offset().left + b.$tb.outerWidth() / 2 + (parseFloat(b.$tb.find(".fr-arrow").css("margin-left")) || 0) + b.$tb.find(".fr-arrow").outerWidth() / 2, b.node.hasClass(b.$tb.get(0), "fr-above") && e && (e += b.$tb.outerHeight()), h = 0), l = x[a].data("container"), !b.opts.iframe || h || k || (d && (d -= b.$iframe.offset().left), e && (e -= b.$iframe.offset().top)), l.is(b.$tb) ? b.$tb.css("zIndex", (b.opts.zIndex || 1) + 4) : x[a].css("zIndex", (b.opts.zIndex || 1) + 4), d && (d -= j / 2), b.opts.toolbarBottom && l && b.$tb && l.get(0) == b.$tb.get(0) && (x[a].addClass("fr-above"), e && (e -= x[a].outerHeight())), x[a].removeClass("fr-active"),
                b.position.at(d, e, x[a], h || 0), x[a].addClass("fr-active"), k || b.accessibility.focusPopup(x[a]), b.opts.toolbarInline && b.toolbar.hide(), b.events.trigger("popups.show." + a), s(a)._repositionPopup(), o()
        }
        ...
        function s(c) {
            ...
            return {
                ...
                _preventFocus: function(c) {
                    ...
                    "mouseup" == c.type || a(f).is(":focus") || e.events.disableBlur(), (b.browser.safari || b.browser.mozilla) && "mousedown" == c.type && a(f).is("input[type=file]") && e.events.disableBlur();
