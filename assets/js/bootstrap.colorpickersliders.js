    ...
    $.fn.ColorPickerSliders = function(options) {
        ...
        return this.each(function() {
            ...
            function showPopover(disableLastlyUsedGroupUpdate) {
                ...
                popover_container = $('<div class="cp-popover-container"></div>').appendTo(triggerelement.parent());
            ...
            function _updateAllElements(disableinputupdate) {
                ...
                if ((100 - color.cielch.l) * color.cielch.a < settings.previewcontrasttreshold) {
                    ...
                    if (triggerelementisinput && settings.previewontriggerelement) {
                        triggerelement.parents('.color-parent').find('.color-dot').css('background', color.tiny.toRgbString()).css('color', '#000');
                    }
                } else {
                    elements.all_sliders.css('color', '#fff');
                    if (triggerelementisinput && settings.previewontriggerelement) {
                        triggerelement.parents('.color-parent').find('.color-dot').css('background', color.tiny.toRgbString()).css('color', '#fff');
                    }
                }
            ...
            function _updateTriggerelementColor() {
                if (triggerelementisinput && settings.previewontriggerelement) {
                    if ((100 - color.cielch.l) * color.cielch.a < settings.previewcontrasttreshold) {
                        triggerelement.parents('.color-parent').find('.color-dot').css('background-color', color.tiny.toRgbString()).css('color', '#000');
                    } else {
                        triggerelement.parents('.color-parent').find('.color-dot').css('background-color', color.tiny.toRgbString()).css('color', '#fff');
                    }
                }
            }
            ...
            function _renderPreview() {
                elements.sliders.preview.css('background-color', $.fn.ColorPickerSliders.csscolor(color.rgba));
